...
import com.vng.zing.testfeature.model.AuthModel;
...
public class AuthHandler extends HttpServlet{
    ...
    private static final Logger _Logger = ZLogger.getLogger(AuthHandler.class);

    private void doProcess(HttpServletRequest req, HttpServletResponse resp) {
        ThreadProfiler profiler = Profiler.createThreadProfilerInHttpProc("CmdHandler", req);
        try {
            AuthModel.Instance.process(req, resp);
        } catch (Exception ex) {
